...
#define MIN_PACKET_LEN_BYTES	((BYTE)*(NUM_8BIT_FIELDS + 1))	// At least 1 byte for msg ('\0')
#define DECIMAL					10
#define BYTE 					8
...
extern void set_transmission_sender(int addr);
extern void set_transmission_reciever(int addr);
extern void set_transmission_crc(int state);
extern int get_transmission_sender(void);
extern int get_transmission_reciever(void);
extern int get_reciever_sender(void);
