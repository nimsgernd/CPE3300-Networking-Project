...
extern void set_sender(int addr);
extern void set_reciever(int addr);
extern void set_crc(int state);
extern int get_sender(void);
extern int get_reciever(void);
extern int* get_raw_data(void);
extern char* get_ascii_data(void);
extern int get_dataSize(void);
extern void encode(char* msg);
extern int get_sender_addr(void);
